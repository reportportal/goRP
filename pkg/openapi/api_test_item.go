...
func (a *TestItemAPIService) GetAttributeKeysForProjectExecute(r ApiGetAttributeKeysForProjectRequest) ([]string, *http.Response, error) {
	...
	if r.isLatest != nil {
		...
		parameterAddToHeaderOrQuery(localVarQueryParams, "isLatest", defaultValue, "form", "")
...
func (a *TestItemAPIService) GetItemsHistoryExecute(r ApiGetItemsHistoryRequest) (*ComEpamReportportalBaseModelPageComEpamReportportalBaseModelTestItemHistoryElement, *http.Response, error) {
	...
	if r.historyDepth != nil {
		...
		parameterAddToHeaderOrQuery(localVarQueryParams, "historyDepth", defaultValue, "form", "")
