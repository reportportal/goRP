...
type ApiPatchDashboardRequest struct {
	...
	dashboardId                                           int64
	projectKey                                            string
	comEpamReportportalBaseModelDashboardPatchDashboardRQ *ComEpamReportportalBaseModelDashboardPatchDashboardRQ
}

func (r ApiPatchDashboardRequest) ComEpamReportportalBaseModelDashboardPatchDashboardRQ(comEpamReportportalBaseModelDashboardPatchDashboardRQ ComEpamReportportalBaseModelDashboardPatchDashboardRQ) ApiPatchDashboardRequest {
	r.comEpamReportportalBaseModelDashboardPatchDashboardRQ = &comEpamReportportalBaseModelDashboardPatchDashboardRQ
	return r
}

func (r ApiPatchDashboardRequest) Execute() (*ComEpamReportportalBaseReportingOperationCompletionRS, *http.Response, error) {
...
*/
func (a *DashboardAPIService) PatchDashboard(ctx context.Context, dashboardId int64, projectKey string) ApiPatchDashboardRequest {
	return ApiPatchDashboardRequest{
		ApiService:  a,
		ctx:         ctx,
		dashboardId: dashboardId,
...
//
//	@return ComEpamReportportalBaseReportingOperationCompletionRS
func (a *DashboardAPIService) PatchDashboardExecute(r ApiPatchDashboardRequest) (*ComEpamReportportalBaseReportingOperationCompletionRS, *http.Response, error) {
	var (
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.comEpamReportportalBaseModelDashboardPatchDashboardRQ == nil {
		return localVarReturnValue, nil, reportError("comEpamReportportalBaseModelDashboardPatchDashboardRQ is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.comEpamReportportalBaseModelDashboardPatchDashboardRQ
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
